...
public class Luz extends Canvas implements Serializable {
	...
	public void setContacto(int movil) {
		movilCI = movil;
	}
	...
	public void setEncendido(boolean newEncendido) {
		...
		if(oldEncendido!=newEncendido){
			EncendidoEvent event=new EncendidoEvent(this, oldEncendido, newEncendido, movilUA, movilCI);
