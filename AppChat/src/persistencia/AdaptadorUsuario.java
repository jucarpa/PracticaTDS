...
public class AdaptadorUsuario implements IAdaptadorUsuarioDAO{
	...
	public static AdaptadorUsuario getUnicaInstancia() {
		if (unicaInstancia == null) return new AdaptadorUsuario();
	...
	public void registrarUsuario(Usuario usuario) {
		...
		} catch (NullPointerException e) {existe = false;}
	...
	public Usuario recuperarUsuario(int id) {
		...
		LocalDate fechaNacimiento = LocalDate.parse(
				servPersistencia.recuperarPropiedadEntidad(eUsuario, "fechaNacimiento"));
	...
	private List<Contacto> obtenerContactosDeId(String contactosID){
		...
		while(strTok.hasMoreTokens()) {
			...
			else contactos.add(aCI.recuperarContactoIndividual(id));
		}
		return contactos;
	}
